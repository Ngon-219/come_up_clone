      ...
      <div className='laptop:mt-5 laptop:mr-20vh laptop:ml-20vh  border-none'>
        <div className=' grid grid-cols-3'>
          ...
          <div className=' laptop:flex laptop:justify-end hidden'>
            <div className='relative flex flex-row p-4 pt-0 pb-0 h-8 bg-gray-300 w-fit group items-center mr-2' data-dropdown-toggle="dropdown">
              <Image src={settingIcon} alt="" className='w-5 h-5 mr-2'/>
              <p>Event Settings</p>
              <div id='dropdown' className={`group-hover:block bg-white absolute top-10 right-0 hidden text-right shadow-md p-4 w-20vh `}>
